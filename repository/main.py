...
def main(mode=None, config=None):
    ...
    # This is where main execution of code will start

    if mode == 6 or mode == 5:
        config = load_costume(mode, config=config)
    else:
    ...
    # set the number of running threads in CV2 to 1 (prevents deadlocks with pytorch dataloader)
    ...
    #setting pytorch settings for configuration
...
def load_configuration(mode=None):
