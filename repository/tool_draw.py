...
if __name__ == '__main__':
    ...
    if MODE == "1":
        ...
        msgbox("Choose an edge picture", title="Model")
        edge_file = fileopenbox(msg='Select an edge', title='Model', filetypes=[['*.png', '*.jpg', 'Image Files']])
        if not edge_file.endswith('.jpg') and not edge_file.endswith('.png'):
            exit("edge file must be .jpg or .png")
        msgbox("Choose a color_domain picture", title="Model")
        color_domain_file = fileopenbox(msg='Select a color_domain', title='Model',
        ...
        msgbox("Choose a colorful picture", title="Model")
        pic_file = fileopenbox(msg='Select an edge', title='Model', filetypes=[['*.png', '*.jpg', 'Image Files']])
