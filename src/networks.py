...
class G_Generator(BaseNetwork):
    def __init__(self, rs_blocks=8):
        ...
        #This is the generator of the models
        ...
        #ReflectionPad2d is added to add more information to the padd instead of naive white or black padd

        blocks = []

        #rs_blocks dictates the number of resnet blocks to add in the architecture
        #generally the more the res blocks we will add the more the architecture will focus on low depths.

        for _ in range(rs_blocks):
            #Each block is resnet Block of 256 x 2
